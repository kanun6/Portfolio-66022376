...
export default function Home() {
  ...
  const texts = ["Welcome to My Portfolio", "Kittayod Tidyong"]; // Texts to type
  ...
  useEffect(() => {
    const images = ["/image/Acheron1.png", "/image/Acheron2.png", "/image/kafka.png"];
    let currentIndex = 0;
    ...
    >
      <div className="text-center flex flex-col items-center">
        ...
        {showButton && (
          <button
            onClick={handleClick}
            className="mt-8 px-10 py-4 text-lg font-medium text-white bg-gradient-to-r from-purple-500 to-pink-600 rounded-full shadow-lg hover:from-purple-400 hover:to-pink-500 hover:scale-105 transform transition duration-300 focus:outline-none focus:ring-4 focus:ring-pink-300 opacity-100 animate-fade-in"
          >
            View My Portfolio
          </button>
        )}
